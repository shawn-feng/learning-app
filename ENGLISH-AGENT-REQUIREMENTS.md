...
- 日期:2026-08-31 初版;2026-09-04 多次调整;**2026-09-04 终版定调:英语作为一门普通学科,课程管理/引导/考核/记录/家长排计划全部复用现有 topics/courses 体系,不单独创建;差异仅两点——教学用中文、教学后可做发音测评且测评记入 daily**。
...
**不新建**:独立英语会话、独立 AGENTS ref、独立入口/路由、独立评测表、独立选课 UI、session-sync 特殊递归。
...
2. 英语教学语言支持:child agent 按 topic `teach_lang` 切换英文(prompt 注入语言指令;复用现有会话/AGENTS,不新建)。
